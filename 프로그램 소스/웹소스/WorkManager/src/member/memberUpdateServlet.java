...
public class memberUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		memberDAO.memberN(EMP_NO);
		int result = memberDAO.memberBasicUpdate(EMP_ID, EMP_EMAIL, EMP_NO);	
		if(result == 1) {
			int result2 =memberDAO.memberHireUpdate(workPlace, salType, STD_salary, WORK_DAY, REST_DAY, START_TIME, END_TIME, SALDATE, EMP_NO);

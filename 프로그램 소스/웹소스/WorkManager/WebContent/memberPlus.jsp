...
<% 
	...
	ArrayList<memberDTO> memberList = new memberDAO().getMemberW();
	%>
	<head>
                            ...
                            <div class="panel panel-default">                               
								...
								%>
                                            <tr class="odd gradeX">
                                                ...
                                                <td style = "text-align :center"><%=member.getEMP_ID()%></td>
                                               	<td style = "text-align :center"><%=member.getEMP_PW() %></td>
                                                <td style = "text-align :center"><%=member.getEMP_EMAIL() %></td>
                                                <td style = "text-align :center">
											    <button class="btn btn-primary fa fa-plus" onclick ="location.href='memberPlus?EMP_NO=<%=member.getEMP_NO()%>'">승인</button>
                                                <button class="btn btn-danger fa fa-minus" onclick ="location.href='memberDelete?EMP_NO=<%=member.getEMP_NO()%>'">삭제</button>
												</td>
                                            </tr>
                                  <%
									}

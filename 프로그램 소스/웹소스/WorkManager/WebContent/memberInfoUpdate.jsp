...
<html lang="kor">
	...
	if(request.getParameter("EMP_NO") != null){
		EMP_NO = (String) request.getParameter("EMP_NO");
	}
	...
	memberDTO memberHire = memberDAO.getMemberHire(EMP_NO);
            ...
            <!-- 출근중 -->
             <div class="row">
                          ...
                          <div class="panel-body">
                              ...
                              <div class="container">
                                  <div class="col-sm-2">
                                    ...
                                    <div class="huge"><%=memberHire.getEMP_NAME() %>
                                    <h2 class="pull-right"><%= memberHire.getWorkPlace() %></h2>
                                	</div>
                              </div>
                              <br>
                        ...
                        <div class="container">
                          ...
                          <p> 이름  : <%=memberHire.getEMP_NAME() %>  <br></p>
							<p>	id(전화번호) : <input type = "text" class="form-control" placeholder ="ID(전화번호)" id ="EMP_ID" name ="EMP_ID" maxlength ="20" value="<%= memberHire.getEMP_ID() %>"><br> </p>
							<p>	email : <input type = "email" class="form-control" placeholder ="이메일" id ="EMP_EMAIL" name ="EMP_EMAIL" maxlength ="20" value="<%= memberHire.getEMP_EMAIL() %>"><br> </p>
							<p>    사원번호 : <%=memberHire.getEMP_NO() %><br> </p>
                              ...
                              <div class="well well-lg">
                           <p>    사원번호 : <%=memberHire.getEMP_NO() %><br> </p>
                          <p>    근무지명 : <input type = "text" class="form-control" placeholder ="근무지" id ="workPlace" name ="workPlace" maxlength ="20" value="<%= memberHire.getWorkPlace() %>"><br> </p>
 						  <p> 급여종류 :  <input type = "text" class="form-control" placeholder ="시급 /월급" id ="salType" name ="salType" maxlength ="20" value="<%= memberHire.getSalType() %>"><br> </p>
                          <p> 기준급여 :  <input type = "text" class="form-control" placeholder ="숫자만 입력하시오" id ="STD_salary" name ="STD_salary" maxlength ="20" value="<%= memberHire.getSTD_Salary() %>"><br> </p>
                          <p> 주 근로일 : <input type = "text" class="form-control" id ="WORK_DAY" name ="WORK_DAY" value="<%= memberHire.getWORK_DAY() %>">
                  		  			주휴일:	<input type = "text" class="form-control" id ="REST_DAY" name ="REST_DAY" value="<%= memberHire.getREST_DAY() %>"><br>  </p>
                  		  <p> 기준 근로시간 : <input type = "time" class="form-control" id ="START_TIME" name ="START_TIME"> ~
                  		   ...
                  		   <p> 월급일 :  <input type = "text" class="form-control" placeholder ="숫자만 입력하시오" id ="SALDATE" name ="SALDATE" maxlength ="20" value="<%= memberHire.getSALDATE() %>"><br> </p>
           				   <input type ="hidden" name ="EMP_NO"  id ="EMP_NO" value= "<%=memberHire.getEMP_NO() %>">

          			...
          			<table class = "table table-striped" style = "text-align : center; border : 1px solid #dddddd">
						<thead>
          				...
          				<tbody>
          					...
          					<tr>
          						<td>글제목</td>
          						<td colspan ="2"><input type ="text" class ="form-control" placeholder = "글 제목" name ="boardTitle" maxlength = "50" value="<%= board.getBoardTitle() %>"></td>
          					</tr>
          					
          					<tr>
          						<td>글내용</td>
          						<td colspan ="2"><textarea class ="form-control" placeholder = "글 내용" name ="boardContent"  rows ="10" maxlength = "2048" ><%= board.getBoardContent()%></textarea></td>
          				 	</tr>
          				 	<tr>
          				 	<td>파일 업로드</td>
          				 	<td colspan ="2"><input type ="file" class ="form-control" name ="boardFile" placeholder="<%=board.getBoardFile()%>"></td>
          				 	</tr>
          				 	<tr>
          					 <td colspan="3" style ="text-align:left"><h5 style="color:red;"></h5><input class ="btn btn-primary pull-right" type ="submit" value ="수정"></td>
          					</tr>
          				</tbody>
          			</table>
          		 </form>

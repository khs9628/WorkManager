...
<head>
	...
	function passwordCheckFunction(){
		...
		var userPassword2 = $('#memberPassword2').val();
          ...
          <div class="container">
              <form method ="post" action ="./memberRegister">
                            <table width="100%" class="table table-striped table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
                                    ...
                                    <td><input type = "text" class="form-control" placeholder ="아이디(핸드폰 번호)" id ="EMP_ID" name ="EMP_ID" maxlength ="20"></td>
                                    <td style="width:110px;"><button class ="btn btn-primary" type="button" onclick="registerCheckFunction();">중복 체크</button></td>
                                    </tr>
                                    <tr>
                                    <td style="width:110px;"><h5>비밀번호</h5></td>
                                    <td colspan="2"><input type = "password" class="form-control" placeholder ="비밀번호" name ="EMP_PW" id ="memberPassword" onkeyup="passwordCheckFunction();" maxlength ="20"></td>
                                    </tr>
                                     <tr>
                                    <td style="width:110px;"><h5>비밀번호 확인</h5></td>
									<td colspan="2"><input type = "password" class="form-control" placeholder ="비밀번호확인" name ="EMP_PW2" id ="memberPassword2" onkeyup="passwordCheckFunction();" maxlength ="20"></td>
                                    </tr>
                                       <tr>
                                    <td style="width:110px;"><h5>이름</h5></td>
									<td colspan="2"><input type = "text" class="form-control" placeholder ="이름" name =EMP_NAME id = "EMP_NAME" maxlength ="20"></td>
                                    </tr>
                                        <tr>
                                    <td style="width:110px;"><h5>이메일</h5></td>
									<td colspan="2"><input type = "email" class="form-control" placeholder ="e-mail" id="EMP_EMAIL" name ="EMP_EMAIL" maxlength ="50"></td>
                                    </tr>
